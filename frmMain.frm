...
' //
' // VB Language Pack Generator 1.10
...
Private Sub cmdGenerate_Click()
  ...
  Open sOutputFile For Output As #1
    ...
    For i = 1 To UBound(FormProp)
      ...
      Print #1, "Caption=" & Chr$(34) & FormProp(i).NewCaption & Chr$(34)
      For j = 1 To FormProp(i).ObjectNumber
        Print #1, FormProp(i).objProp(j).Name & ".Caption=" & Chr$(34) & FormProp(i).objProp(j).NewCaption & Chr$(34)
        If FormProp(i).objProp(j).NewToolTip <> "" Then
          Print #1, FormProp(i).objProp(j).Name & ".ToolTip=" & Chr$(34) & FormProp(i).objProp(j).NewToolTip & Chr$(34)
        End If
      Next
...
Private Sub tvForms_NodeClick(ByVal Node As MSComctlLib.Node)
  ...
  Dim i As Integer, bAdded(5) As Boolean
